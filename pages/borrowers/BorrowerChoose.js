...
export default function BorrowerChoose() {
  const { t, i18n } = useTranslation("borrowers");
  const isMobile = useMediaQuery((theme) => theme.breakpoints.down("md"));

  const textContent = t("whyRaqamyah", { returnObjects: true });
            ...
            <CardActionArea>
              <LogoCardContent>
                <FlexContainer>
                  {index === 0 && (
                    <VectorImage
                      src={images.chooseLogo1}
                      alt={`${card.title} icon`}
                    />
                  )}
                  {index === 1 && (
                    <BankImage
                      src={images.chooseLogo2}
                      alt={`${card.title} icon`}
                    />
                  )}
                  {index === 2 && (
                    <SparkleImage
                      src={images.chooseLogo3}
                      alt={`${card.title} icon`}
                    />
                  )}
                </FlexContainer>
